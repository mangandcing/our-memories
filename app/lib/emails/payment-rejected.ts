...
export function paymentRejectedEmail(params: {
  ...
  const { customerName, pageTitle, reason, portalUrl } = params

  const content = `
<h2 style="margin:0 0 8px;font-size:22px;color:#1a1a2e;">Payment Screenshot Issue</h2>
<p style="margin:0 0 24px;font-size:15px;color:#555555;">Hi ${customerName}, we were unable to verify your payment screenshot for <strong>${pageTitle}</strong>. Don't worry — this is easy to fix.</p>
...
<p style="margin:0 0 8px;font-size:12px;color:#cc7733;text-transform:uppercase;letter-spacing:1px;font-weight:600;">Reason from our team</p>
<p style="margin:0;font-size:14px;color:#555555;">${reason}</p>
</td></tr>
</table>

<h3 style="margin:0 0 12px;font-size:15px;color:#1a1a2e;">How to fix this</h3>
<ol style="margin:0 0 24px;padding-left:20px;font-size:14px;color:#555555;line-height:1.8;">
<li>Make your payment via KBZ Pay, Wave Money, AYA Pay, Bangkok Bank QR, or True Money</li>
<li>Take a clear screenshot showing the transaction confirmation</li>
<li>Log in to your portal and re-upload the screenshot</li>
</ol>

<div style="text-align:center;margin:28px 0;">
<a href="${portalUrl}" style="display:inline-block;background:#d4af37;color:#1a1a2e;font-size:14px;font-weight:700;padding:14px 36px;border-radius:6px;text-decoration:none;letter-spacing:0.5px;">Re-upload Screenshot →</a>
</div>

<p style="margin:24px 0 0;font-size:13px;color:#888888;border-top:1px solid #eeeeea;padding-top:20px;">Still having trouble? Contact us on <a href="https://t.me/ourmemories" style="color:#d4af37;text-decoration:none;">Telegram</a> and we'll help you right away.</p>
`
